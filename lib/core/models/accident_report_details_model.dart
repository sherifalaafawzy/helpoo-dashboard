...
class Report {
  ...
  Report.fromJson(Map<String, dynamic> json) {
    ...
    billDeliveryLocation = json['billDeliveryLocation'] != null
        ? (json['billDeliveryLocation'] as List).map((e) => LocationModel.fromJson(e)).toList()
        : null;
    beforeRepairLocation = json['beforeRepairLocation'] != null
        ? (json['beforeRepairLocation'] as List).map((e) => LocationModel.fromJson(e)).toList()
        : null;
    afterRepairLocation = json['afterRepairLocation'] != null
        ? (json['afterRepairLocation'] as List).map((e) => LocationModel.fromJson(e)).toList()
        : null;
    video = json['video'] ?? '';
    ...
    rightSaveLocation = json['rightSaveLocation'] != null
        ? (json['rightSaveLocation'] as List).map((e) => LocationModel.fromJson(e)).toList()
        : null;

    supplementLocation = json['supplementLocation'] != null
        ? (json['supplementLocation'] as List).map((e) => LocationModel.fromJson(e)).toList()
        : null;
    resurveyLocation = json['resurveyLocation'] != null
        ? (json['resurveyLocation'] as List).map((e) => LocationModel.fromJson(e)).toList()
        : null;
    ...
    carAccidentReports = json['CarAccidentReports'] != null
        ? (json['CarAccidentReports'] as List).map((e) => CarAccidentReportModel.fromJson(e)).toList()
        : null;
    ...
    sentToInsurance = json['sentToInsurance'] ?? false;
    insuranceCompany = json['insuranceCompany'] != null ? InsuranceCompanyModel.fromJson(json['insuranceCompany']) : null;
  }
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'Car': car?.toJson(),
      'CarAccidentReports': carAccidentReports?.map((v) => v.toJson()).toList(),
      'accidentTypes': accidentTypes?.map((v) => v.toJson()).toList(),
      'Client': clientModel?.toJson(),
      'sentToInsurance': sentToInsurance,
...
class Car {
  ...
  Car.fromJson(Map<String, dynamic> json) {
    ...
    insuranceCompanyId = json['insuranceCompanyId'] ?? 0;
    insuranceCompany =
        json['insuranceCompany'] != null ? InsuranceCompanyModel.fromJson(json['insuranceCompany']) : null;
