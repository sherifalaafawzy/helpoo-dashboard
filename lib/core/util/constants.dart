...
import 'widgets/shared_widgets/error_imge_holder.dart';
...
dynamic currentCompanyId;
String currentInsuranceCompanyName = '';
// int corporateId = 0;
// any created by sent this Id Not current Company Id
int currentUserId = 0;
int generalID = 0;
...
class Keys {
  ...
  static const currentCompanyId = 'currentCompanyId';
  static const currentCompanyName = 'currentCompanyName';
  static const currentInsuranceCompanyId = 'currentInsuranceCompanyId';
  ...
  static const fixedColumns = 'fixedColumns';
  static const generalID = 'generalID';
}
...
// const Color backgroundColor = Color.fromRGBO(	45, 45, 45, 1.0);
