...
import '../../../core/models/corporates/corporate_users_model.dart';
...
class CorporateUsersTable extends StatefulWidget {
  const CorporateUsersTable({super.key});

  @override
  State<CorporateUsersTable> createState() => _CorporateUsersTableState();
}

class _CorporateUsersTableState extends State<CorporateUsersTable> {
  // pagination logic
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppBloc, AppState>(
      ...
      builder: (context, state) {
        if (appBloc.corporateUsersModel?.users?.isEmpty ?? true) {
          return emptyCase();
        }
                ...
                children: [
                  ...
                  PrimaryTableWidget(
                    ...
                    paginationWidget: TablePaginationBar(
                      items: appBloc.corporateUsersModel?.users ?? [],
  ...
  TableRow tableItem({
    required CorporateUsers client,
  }) {
    return TableRow(
