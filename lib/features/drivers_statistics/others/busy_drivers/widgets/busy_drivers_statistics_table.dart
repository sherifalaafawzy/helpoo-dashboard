...
class BusyDriverStatisticsTable extends StatefulWidget {
  const BusyDriverStatisticsTable({super.key});

  @override
  State<BusyDriverStatisticsTable> createState() =>
      _BusyDriverStatisticsTableState();
}

class _BusyDriverStatisticsTableState extends State<BusyDriverStatisticsTable> {
  // pagination logic
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppBloc, AppState>(
      ...
      builder: (context, state) {
        if (appBloc.busyDriversStatistics?.rows?.isEmpty ?? true) {
          return emptyCase();
        }
                ...
                children: [
                  ...
                  PrimaryTableWidget(
                    ...
                    paginationWidget: TablePaginationBar(
                      items: appBloc.busyDriversStatistics?.rows ?? [],
