...
class OfflineDriverStatisticsTable extends StatefulWidget {
  const OfflineDriverStatisticsTable({super.key});

  @override
  State<OfflineDriverStatisticsTable> createState() =>
      _OfflineDriverStatisticsTableState();
}

class _OfflineDriverStatisticsTableState
    extends State<OfflineDriverStatisticsTable> {
  // pagination logic
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppBloc, AppState>(
      ...
      builder: (context, state) {
        if (appBloc.offlineDrivers?.rows?.isEmpty ?? true) {
          return emptyCase();
        }
                ...
                children: [
                  ...
                  PrimaryTableWidget(
                    ...
                    paginationWidget: TablePaginationBar(
                      items: appBloc.offlineDrivers?.rows ?? [],
