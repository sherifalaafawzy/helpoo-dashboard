...
class OnlineDriverStatisticsTable extends StatefulWidget {
  const OnlineDriverStatisticsTable({super.key});

  @override
  State<OnlineDriverStatisticsTable> createState() =>
      _OnlineDriverStatisticsTableState();
}

class _OnlineDriverStatisticsTableState
    extends State<OnlineDriverStatisticsTable> {
  // pagination logic
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppBloc, AppState>(
      ...
      builder: (context, state) {
        if (appBloc.onlineDrivers?.rows?.isEmpty ?? true) {
          return emptyCase();
        }
                ...
                children: [
                  ...
                  PrimaryTableWidget(
                    ...
                    paginationWidget: TablePaginationBar(
                      items: appBloc.onlineDrivers?.rows ?? [],
