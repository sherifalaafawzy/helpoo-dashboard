...
class DriverStatisticsTable extends StatefulWidget {
  const DriverStatisticsTable({super.key});

  @override
  State<DriverStatisticsTable> createState() => _DriverStatisticsTableState();
}

class _DriverStatisticsTableState extends State<DriverStatisticsTable> {
  // pagination logic
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppBloc, AppState>(
      ...
      builder: (context, state) {
        if (appBloc.allDrivers?.rows?.isEmpty ?? true) {
          return emptyCase();
        }
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'All Drivers: ${appBloc.allDrivers?.count ?? 0}',
                          style:
                        ...
                        Text(
                          'Busy Drivers: ${appBloc.busyDriversStatistics?.count ?? 0}',
                          style:
                              Theme.of(context).textTheme.titleSmall!.copyWith(
                                    color: Colors.black,
                                  ),
                        ...
                        Text(
                          'Free Drivers: ${appBloc.freeDriversStatistics?.count ?? 0}',
                          style:
                              Theme.of(context).textTheme.titleSmall!.copyWith(
                                    color: Colors.black,
                                  ),
                        ...
                        Text(
                          'Online Drivers: ${appBloc.onlineDrivers?.count ?? 0}',
                          style:
                              Theme.of(context).textTheme.titleSmall!.copyWith(
                                    color: Colors.black,
                                  ),
                        ...
                        Text(
                          'Offline Drivers: ${appBloc.offlineDrivers?.count ?? 0}',
                          style:
                              Theme.of(context).textTheme.titleSmall!.copyWith(
                                    color: Colors.black,
                                  ),
