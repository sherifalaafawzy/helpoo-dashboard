...
class InspectorUsersTable extends StatefulWidget {
  const InspectorUsersTable({super.key});

  @override
  State<InspectorUsersTable> createState() => _InspectorUsersTableState();
}

class _InspectorUsersTableState extends State<InspectorUsersTable> {
  // pagination logic
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppBloc, AppState>(
      ...
      builder: (context, state) {
        if (appBloc.inspectorsUsersList.isEmpty) {
          return emptyCase();
        }
                ...
                children: [
                  ...
                  PrimaryTableWidget(
                    ...
                    paginationWidget: TablePaginationBar(
                      items: appBloc.inspectorsUsersList,
