...
class InsuranceUsersTable extends StatefulWidget {
  const InsuranceUsersTable({super.key});

  @override
  State<InsuranceUsersTable> createState() => _InsuranceUsersTableState();
}

class _InsuranceUsersTableState extends State<InsuranceUsersTable> {
  // pagination logic
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppBloc, AppState>(
      ...
      builder: (context, state) {
        if (appBloc.insuranceUsersList.isEmpty) {
          return emptyCase();
        }
                ...
                children: [
                  ...
                  PrimaryTableWidget(
                    ...
                    paginationWidget: TablePaginationBar(
                      items: appBloc.insuranceUsersList,
