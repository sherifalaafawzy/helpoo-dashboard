...
class BusyVehiclesStatisticsTable extends StatefulWidget {
  const BusyVehiclesStatisticsTable({super.key});

  @override
  State<BusyVehiclesStatisticsTable> createState() =>
      _BusyVehiclesStatisticsTableState();
}

class _BusyVehiclesStatisticsTableState
    extends State<BusyVehiclesStatisticsTable> {
  // pagination logic
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppBloc, AppState>(
      ...
      builder: (context, state) {
        if (appBloc.busyVehicles?.rows?.isEmpty ?? true) {
          return emptyCase();
        }
                ...
                children: [
                  ...
                  PrimaryTableWidget(
                    ...
                    paginationWidget: TablePaginationBar(
                      items: appBloc.busyVehicles?.rows ?? [],
