...
class FreeVehiclesStatisticsTable extends StatefulWidget {
  const FreeVehiclesStatisticsTable({super.key});

  @override
  State<FreeVehiclesStatisticsTable> createState() =>
      _FreeVehiclesStatisticsTableState();
}

class _FreeVehiclesStatisticsTableState
    extends State<FreeVehiclesStatisticsTable> {
  // pagination logic
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppBloc, AppState>(
      ...
      builder: (context, state) {
        if (appBloc.freeVehicles?.rows?.isEmpty ?? true) {
          return emptyCase();
        }
                ...
                children: [
                  ...
                  PrimaryTableWidget(
                    ...
                    paginationWidget: TablePaginationBar(
                      items: appBloc.freeVehicles?.rows ?? [],
