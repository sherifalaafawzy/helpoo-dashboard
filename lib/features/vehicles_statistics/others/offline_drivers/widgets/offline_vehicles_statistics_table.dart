...
class OfflineVehiclesStatisticsTable extends StatefulWidget {
  const OfflineVehiclesStatisticsTable({super.key});

  @override
  State<OfflineVehiclesStatisticsTable> createState() =>
      _OfflineVehiclesStatisticsTableState();
}

class _OfflineVehiclesStatisticsTableState
    extends State<OfflineVehiclesStatisticsTable> {
  // pagination logic
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppBloc, AppState>(
      ...
      builder: (context, state) {
        if (appBloc.offlineVehicles?.rows?.isEmpty ?? true) {
          return emptyCase();
        }
                ...
                children: [
                  ...
                  PrimaryTableWidget(
                    ...
                    paginationWidget: TablePaginationBar(
                      items: appBloc.offlineVehicles?.rows ?? [],
