...
class VehiclesStatisticsTable extends StatefulWidget {
  const VehiclesStatisticsTable({super.key});

  @override
  State<VehiclesStatisticsTable> createState() =>
      _VehiclesStatisticsTableState();
}

class _VehiclesStatisticsTableState extends State<VehiclesStatisticsTable> {
  // pagination logic
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<AppBloc, AppState>(
      ...
      builder: (context, state) {
        if (appBloc.allVehicles?.rows?.isEmpty ?? true) {
          return emptyCase();
        }
                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          'All Vehicles: ${appBloc.allVehicles?.count ?? 0}',
                          style:
                        ...
                        Text(
                          'Busy Vehicles: ${appBloc.busyVehicles?.count ?? 0}',
                          style:
                              Theme.of(context).textTheme.titleSmall!.copyWith(
                                    color: Colors.black,
                                  ),
                        ...
                        Text(
                          'Free Vehicles: ${appBloc.freeVehicles?.count ?? 0}',
                          style:
                              Theme.of(context).textTheme.titleSmall!.copyWith(
                                    color: Colors.black,
                                  ),
                        ...
                        Text(
                          'Online Vehicles: ${appBloc.onlineVehicles?.count ?? 0}',
                          style:
                              Theme.of(context).textTheme.titleSmall!.copyWith(
                                    color: Colors.black,
                                  ),
                        ...
                        Text(
                          'Offline Vehicles: ${appBloc.offlineVehicles?.count ?? 0}',
                          style:
                              Theme.of(context).textTheme.titleSmall!.copyWith(
                                    color: Colors.black,
                                  ),
                  ...
                  PrimaryTableWidget(
                    ...
                    paginationWidget: TablePaginationBar(
                      items: appBloc.allVehicles?.rows ?? [],
